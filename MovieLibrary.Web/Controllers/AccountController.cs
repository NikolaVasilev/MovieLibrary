...
using MovieLibrary.Web.Models.AccountViewModels;
using System;
...
namespace MovieLibrary.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(
            ...
            ILogger<AccountController> logger, IUserService user)
        {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    User user = await _user.FindUserByUserName(model.Username);
                    if (await _userManager.IsInRoleAsync(user, RoleConstants.AdministratorRole))
                    {
                        return RedirectToAction("ListLog", "Home", new { area = AreaConstants.AdminArea });
                    }
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new User { UserName = model.UserName, Email = model.Email, FirstName = model.FirstName, LastName = model.LastName, BirthDate = model.BirthDate, ImgPath = path};
                ...
                if (result.Succeeded)
                {
                    ...
                    _logger.LogInformation("User created a new account with password.");
                    await _userManager.AddToRoleAsync(user, RoleConstants.AuthenticatedUserRole);
                    return RedirectToLocal(returnUrl);
                }
                AddErrors(result);
            }
